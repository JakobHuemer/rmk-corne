...
use crate::keymap::COL;
use crate::keymap::COL_MASTER;
use crate::keymap::NUM_LAYER;
use crate::keymap::NUM_ENCODER;
...
async fn main(spawner: Spawner) {
    ...
    /*
     * pinouts: [P0_29, P0_02, P1_15, P1_13, P1_11]
     * pinins: [P0_22, P0_24, P1_00, P0_11]
     */

    // Initialize IO Pins
    let (input_pins, output_pins) = config_matrix_pins_nrf!(peripherals: p, input: [P0_22, P0_24, P1_00, P0_11], output:  [P0_29, P0_02, P1_15, P1_13, P1_11]);
    ...
    let mut matrix = CentralMatrix::<_, _, _, 0, 0, ROW, COL_MASTER>::new(input_pins, output_pins, debouncer);
    // let mut matrix = TestMatrix::<ROW, COL>::new();
    let mut keyboard = Keyboard::new(&keymap);

    // Read peripheral address from storage
    let peripheral_addrs = read_peripheral_addresses::<1, _, ROW, COL, NUM_LAYER, NUM_ENCODER>(&mut storage).await;
    ...
    join4(
        ...
        join(
            run_peripheral_manager::<ROW, COL, 0, 0, _>(0, peripheral_addrs[0], &stack),
